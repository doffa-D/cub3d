...
// 		if(check_is_wall > 0 && x_next_point_position > 0 && check_is_wall <  cub->WINDOW_WIDTH * (TILE_SIZE * MINI_MAP) && x_next_point_position < cub->WINDOW_WIDTH  * (TILE_SIZE * MINI_MAP) && cub->map[(int)floor((check_is_wall  / (TILE_SIZE * MINI_MAP)))] && cub->close_dor % 2 == 0 && cub->map[(int)floor((check_is_wall  / (TILE_SIZE * MINI_MAP)))][(int)floor((x_next_point_position  / (TILE_SIZE * MINI_MAP)))] == 'D' && cub->map[(int)floor(cub->player.y  / (TILE_SIZE * MINI_MAP))][(int)floor(cub->player.x  / (TILE_SIZE * MINI_MAP))] != 'D')
// 		{
...
// 			break;
// 		}
// 		else if(check_is_wall < cub->WINDOW_HEIGHT * (TILE_SIZE * MINI_MAP) 
...
// 		if(y_next_point_position > 0 && check_is_wall > 0 && y_next_point_position <  cub->WINDOW_WIDTH * (TILE_SIZE * MINI_MAP) && check_is_wall < cub->WINDOW_WIDTH  * (TILE_SIZE * MINI_MAP) && cub->map[(int)floor((y_next_point_position  / (TILE_SIZE * MINI_MAP)))] && cub->close_dor % 2 == 0 && cub->map[(int)floor((y_next_point_position  / (TILE_SIZE * MINI_MAP)))][(int)floor((check_is_wall  / (TILE_SIZE * MINI_MAP)))] == 'D' && cub->map[(int)floor(cub->player.y  / (TILE_SIZE * MINI_MAP))][(int)floor(cub->player.x  / (TILE_SIZE * MINI_MAP))] != 'D')
// 		{
...
// 			break;
// 		}
// 		else if(y_next_point_position < cub->WINDOW_HEIGHT * (TILE_SIZE * MINI_MAP) \
...
{ //TODO: All the crazy logic for horz, vert, ...
		   ...
		   nextHorzTouchY >= 0 && nextHorzTouchY <= cub->WINDOW_HEIGHT * (TILE_SIZE * MINI_MAP))
	{
		...
		// if(yToCheck > 0 && yToCheck < cub->WINDOW_WIDTH && xToCheck > 0 && xToCheck < cub->WINDOW_WIDTH && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))] && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))][(int)floor((xToCheck  / (TILE_SIZE * MINI_MAP)))] == '1')
		   ...
		   nextVertTouchY >= 0 && nextVertTouchY <= cub->WINDOW_HEIGHT * (TILE_SIZE * MINI_MAP))
	{
		...
		// if(yToCheck > 0 && yToCheck < cub->WINDOW_WIDTH && xToCheck > 0 && xToCheck < cub->WINDOW_WIDTH && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))] && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))][(int)floor((xToCheck  / (TILE_SIZE * MINI_MAP)))] == '1')
		// if(yToCheck > 0 && xToCheck > 0 && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))] && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))][(int)floor((xToCheck  / (TILE_SIZE * MINI_MAP)))] == '1')
		if(yToCheck > 0 && xToCheck > 0 && yToCheck <  cub->WINDOW_WIDTH * (TILE_SIZE * MINI_MAP) && xToCheck < cub->WINDOW_WIDTH  * (TILE_SIZE * MINI_MAP) && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))] && cub->map[(int)floor((yToCheck  / (TILE_SIZE * MINI_MAP)))][(int)floor((xToCheck  / (TILE_SIZE * MINI_MAP)))] == '1')
		{// Found a wall hit
    ...
    cub->rays[stripId].rayAngle			 = rayAngle;
    cub->rays[stripId].facing_down	 = isRayFacingDown;
    cub->rays[stripId].facing_up		 = isRayFacingUp;
    cub->rays[stripId].facing_right	 = isRayFacingRight;
    cub->rays[stripId].facing_left	 = isRayFacingLeft;
}
