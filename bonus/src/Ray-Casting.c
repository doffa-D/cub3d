...
/*   Updated: 2023/07/12 20:26:26 by nouakhro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				castRay(t_struct *cub,float rayAngle, int stripId)
{
		   ...
		   y_next_point_position >= 0 && y_next_point_position <= cub->WINDOW_HEIGHT * (TILE_SIZE * MINI_MAP))
	{
		...
		if((check_is_wall > 0 && x_next_point_position > 0 && check_is_wall <  cub->WINDOW_WIDTH * (TILE_SIZE * MINI_MAP) && x_next_point_position < cub->WINDOW_WIDTH  * (TILE_SIZE * MINI_MAP) 
		&& cub->close_dor % 2 == 0 && cub->map[(int)floor((check_is_wall  / (TILE_SIZE * MINI_MAP)))]  
		&& x_next_point_position / (TILE_SIZE * MINI_MAP) < ft_strlen(cub->map[(int)floor((check_is_wall  / (TILE_SIZE * MINI_MAP)))])) 
		&& cub->map[(int)floor((check_is_wall  / (TILE_SIZE * MINI_MAP)))][(int)floor((x_next_point_position  / (TILE_SIZE * MINI_MAP)))] == 'D' 
		&& cub->map[(int)floor(cub->player.y  / (TILE_SIZE * MINI_MAP))][(int)floor(cub->player.x  / (TILE_SIZE * MINI_MAP))] != 'D')
		{
		...
		else if((check_is_wall < cub->WINDOW_HEIGHT * (TILE_SIZE * MINI_MAP) && x_next_point_position < cub->WINDOW_WIDTH * (TILE_SIZE * MINI_MAP) && check_is_wall > 0 && x_next_point_position > 0 
		...
		&& x_next_point_position >= 0)
	{
		...
		if((y_next_point_position > 0 && check_is_wall > 0 && y_next_point_position <  cub->WINDOW_WIDTH * (TILE_SIZE * MINI_MAP) && check_is_wall < cub->WINDOW_WIDTH  * (TILE_SIZE * MINI_MAP)) 
		&& cub->map[(int)floor((y_next_point_position  / (TILE_SIZE * MINI_MAP)))] && cub->close_dor % 2 == 0 
		&& check_is_wall / (TILE_SIZE * MINI_MAP) < ft_strlen(cub->map[(int)floor((y_next_point_position  / (TILE_SIZE * MINI_MAP)))])
		&& cub->map[(int)floor((y_next_point_position  / (TILE_SIZE * MINI_MAP)))][(int)floor((check_is_wall  / (TILE_SIZE * MINI_MAP)))] == 'D' && cub->map[(int)floor(cub->player.y  / (TILE_SIZE * MINI_MAP))][(int)floor(cub->player.x  / (TILE_SIZE * MINI_MAP))] != 'D')
		{
